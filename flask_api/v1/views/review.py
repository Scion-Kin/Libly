...
@grand_view.route('/<string:book_id>/reviews', methods=['GET'],
...
@grand_view.route('/reviews/<string:review_id>', methods=['GET'],
                  strict_slashes=False)
...
@grand_view.route('/reviews/<string:review_id>', methods=['PUT'],
                  strict_slashes=False)
def update_review(review_id):
    ...
    admins = [i for i in storage.all("User").values()
              if i.password == request.get_json()["password"]]
...
@grand_view.route('/reviews/<string:review_id>', methods=['DELETE'],
                  strict_slashes=False)
